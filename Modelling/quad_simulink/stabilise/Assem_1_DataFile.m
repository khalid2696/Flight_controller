...
smiData.Solid(1).mass = 0.0061053719906995086;  % kg
smiData.Solid(1).CoM = [0 1.2853448205600579 0];  % mm
smiData.Solid(1).MoI = [12.782981371116833 12.88545507666926 0.15655852931853104];  % kg*mm^2
smiData.Solid(1).PoI = [0 -0.01460602088907469 0];  % kg*mm^2
smiData.Solid(1).color = [0 1 0];
smiData.Solid(1).opacity = 1;
smiData.Solid(1).ID = 'PROPELLER - 8x4*:*Défaut';

%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(2).mass = 4.4307000823623;  % kg
smiData.Solid(2).CoM = [0.10066935359916851 -0.32176658568147826 1.1214521392313763];  % mm
smiData.Solid(2).MoI = [128458.85671300802 128459.02128688098 256035.75391751243];  % kg*mm^2
smiData.Solid(2).PoI = [15.309552805587396 -13.096481052423675 35.134845839907669];  % kg*mm^2
...
smiData.Solid(3).CoM = [39.999999960591296 1.2853228781777262 1.4347818570328602e-07];  % mm
smiData.Solid(3).MoI = [12.781088813395158 12.883570155783563 0.15656950018054955];  % kg*mm^2
smiData.Solid(3).PoI = [-8.3592452705008892e-10 0.014398325598951595 0];  % kg*mm^2
