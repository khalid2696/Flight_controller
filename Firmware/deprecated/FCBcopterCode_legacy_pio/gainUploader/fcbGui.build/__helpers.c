...
static struct Nuitka_MetaPathBasedLoaderEntry meta_path_loader_entries[] =
{
    ...
    { (char *)"serial_Object_handling", MOD_INIT_NAME( serial_Object_handling ), 0, 0, NUITKA_COMPILED_MODULE },
    { (char *)"serialportsExample", MOD_INIT_NAME( serialportsExample ), 0, 0, NUITKA_COMPILED_MODULE },
    { NULL, NULL, 0, 0, 0 }
};
