/* PID library for FCB 2.0
  ...
  *Integral Windup - Limiting integral maximum, stop adding
  ...
  *Adding saturation/cap/Limit the outputs
  ...
  Please note that the default limits given right below are only for attitude control. Alt control pids use a different value
  */
#pragma once
...
//Functions:
  ...
  pid(float,float ,float, float, float = 1.0, float = 0.0, float  = 60);//P D I gains and pidTiming, derivativeCutOff and setpoint weight_b and c
