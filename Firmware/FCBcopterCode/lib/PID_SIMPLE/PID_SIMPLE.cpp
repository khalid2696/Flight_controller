...
//CONTRAINING THE TIME
  ...
  else deltaTime = deltaTime_ms*0.001f;
...
//ERROR CALCULATIONS FOR PID
  ...
  if(pauseIntegral == false){ //global pause
    integralCorrection += ki*error_I*deltaTime;
  }
...
//PID ACTION:
  ...
  */
  limiter(&integralCorrection,-integral_claming_lmt,integral_claming_lmt); //local saturation
