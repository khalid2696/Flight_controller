...
//accceleration in z axis is given from outside this library at regular intervals.
//Small angle approximation is done
//This library then fuses the lidar vel and acceleration integrated vel to give a good estimate of vertical velocity
