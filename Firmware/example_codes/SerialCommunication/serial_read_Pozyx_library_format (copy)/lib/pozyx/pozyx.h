...
4) This comes STM receiver part which is done by this code.
...
:comm(PC_6, PC_7, NoOfIntegars)
{}

int pozyx_arduino_interface::update()
{
  comm.readSerial();
  //int32_t ints[NoOfIntegars]= {-2147483645};
  ...
  // for(int i = 0; i<NoOfIntegars; i++)
  // {
  //   data_flt[i] = (float) ints[i]/1000.0;
  // }
